All sub-directories of the "lib" are for tool-specific JAR files for the specific tool as listed in fits.xml within each <tool> element in the "classpath-dirs" attribute.

...
public class ParentLastClassLoader extends ClassLoader {
	...
	static {
		...
		loadByParentClassLoader.add("org.slf4j");
		loadByParentClassLoader.add("org.apache.log4j"); // Ensure top-level reload4j classes are used instead of Droid and Tika log4j classes. Remove once upgraded to log4j2.
	}

...
public class DocMDXmlUnitServiceTest extends AbstractWebAppTest {
    ...
    public void testWordDocxPasswordProtected() throws Exception {
        testFileInWebApp("WordPasswordProtected.docx");
    }

    @Test
    public void testWordDocmOutput() throws Exception {
        testFileInWebApp("Document_Has_Form_Controls.docm");
    }
    ...
    public void testEpubOutput() throws Exception {
        ...
        for (String inputFilename : inputFilenames) {
            testFileInWebApp(inputFilename);
        }
    }
    ...
    public void testRtfOutput() throws Exception {
        testFileInWebApp("TestDoc.rtf");
    }

    @Test
    public void testRtfWithCompanyOutput() throws Exception {
        testFileInWebApp("Doc2.rtf");
    }

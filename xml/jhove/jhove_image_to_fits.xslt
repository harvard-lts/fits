                ...
                <image>
                    ...
                    <xsl:choose>
                        <xsl:when test="$format='JPEG 2000'">
                            <!-- when image is a jp2 -->
                            <compressionScheme>
                                <xsl:variable name="jp2Compression"
                                              select="//property[name='Transformation']/values/value"/>
                                <xsl:choose>
                    ...
                    <flash>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when
                                    test="$flash='fired, auto mode, red-eye reduction mode, return light not detected'">
                                <xsl:value-of

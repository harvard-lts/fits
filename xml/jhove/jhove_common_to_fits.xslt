                        ...
                        <xsl:when test="starts-with($format,'JPEG 2000')">
                            <xsl:choose>
                                ...
                                <xsl:when test="//property[name='Brand']/values/value">
                                    <xsl:value-of
                                            select="concat('JPEG 2000 ',normalize-space(upper-case(//property[name='Brand']/values/value)))"/>
                                </xsl:when>
            ...
            <creatingApplicationName>
                <xsl:choose>
                            ...
                            <xsl:when test="//property[name='Comments']/values/value">
                                <xsl:for-each select="//property[name='Comments']/values/value">
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            <xsl:value-of
                                                    select="concat(//property[name='Comments']/values/value,', ')"/>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </xsl:for-each>
                            </xsl:when>
                    ...
                    <xsl:when test="$mime='application/pdf'">
                        <xsl:choose>
                            <xsl:when
                                    test="//property[name='Producer']/values/value and //property[name='Creator']/values/value and //property[name='Producer']/values/value != '&lt;May be encrypted&gt;'">
                                <xsl:value-of
                                        select="concat(//property[name='Producer']/values/value,'/',//property[name='Creator']/values/value)"/>
                            </xsl:when>
                            <xsl:otherwise>

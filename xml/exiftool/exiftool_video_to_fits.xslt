                ...
                <video>
                    ...
                    <xsl:choose>
                        <xsl:when test="exiftool/PixelsPerMeterX and exiftool/PixelsPerMeterY">
                            <pixelAspectRatio>
                                <xsl:value-of select="exiftool/PixelsPerMeterX[1]"/><xsl:value-of select="'/'"/><xsl:value-of
                                    select="exiftool/PixelsPerMeterY[1]"/>
                            </pixelAspectRatio>
                        </xsl:when>
                    </xsl:choose>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="exiftool/VideoEncoding and exiftool/AudioEncoding">
                            <encoding>
                                <xsl:value-of
                                        select="concat(exiftool/VideoEncoding[1], ' + ', exiftool/AudioEncoding[1])"/>
                            </encoding>
                        </xsl:when>

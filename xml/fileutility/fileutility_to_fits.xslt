                ...
                <identification>
                    ...
                    <identity>
                        ...
                        <xsl:attribute name="mimetype">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="$format='OpenDocument Drawing Template'">
                                    <xsl:value-of
                                            select="string('application/vnd.oasis.opendocument.graphics-template')"/>
                                </xsl:when>
                                ...
                                <xsl:when test="$format='OpenDocument Presentation Template'">
                                    <xsl:value-of
                                            select="string('application/vnd.oasis.opendocument.presentation-template')"/>
                                </xsl:when>
                                ...
                                <xsl:when test="$format='OpenDocument Spreadsheet Template'">
                                    <xsl:value-of
                                            select="string('application/vnd.oasis.opendocument.spreadsheet-template')"/>
                                </xsl:when>
                                ...
                                <xsl:when test="$format='OpenDocument Formula Template'">
                                    <xsl:value-of
                                            select="string('application/vnd.oasis.opendocument.formula-template')"/>
                                </xsl:when>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when
                                    test="starts-with( translate($format, $lowercase, $uppercase), translate('JPEG image data, EXIF standard', $lowercase, $uppercase))">
                                <xsl:attribute name="format">
                                    ...
                                    <xsl:matching-substring>
                                        <xsl:attribute name="format">
                                            <xsl:if test="regex-group(1)='Ogg data, Vorbis audio'">
                                                <xsl:value-of
                                                        select="string('Ogg Vorbis Codec Compressed Multimedia File')"/>
                                            </xsl:if>
                                        </xsl:attribute>
                                        <!--
                                        <version>
                            ...
                            <xsl:when
                                    test="$mime='application/vnd.openxmlformats-officedocument.wordprocessingml.document'">
                                <xsl:attribute name="format">
                            ...
                            <xsl:when
                                    test="$mime='application/vnd.openxmlformats-officedocument.presentationml.presentation'">
                                <xsl:attribute name="format">

                    ...
                    <exposureProgram>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="$exposureProgram=7">
                                <xsl:value-of
                                        select="string('Portrait mode (for closeup photos with the background out of focus)')"/>
                            </xsl:when>
                            <xsl:when test="$exposureProgram=8">
                                <xsl:value-of
                                        select="string('Landscape mode (for landscape photos with the background in focus)')"/>
                            </xsl:when>
                        </xsl:choose>
                    </exposureProgram>
                    ...
                    <flash>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="$flash=13">
                                <xsl:value-of
                                        select="string('Flash fired, compulsory flash mode, return light not detected')"/>
                            </xsl:when>
                            <xsl:when test="$flash=15">
                                <xsl:value-of
                                        select="string('Flash fired, compulsory flash mode, return light detected')"/>
                            </xsl:when>
                            <!--
                            ...
                            <xsl:when test="$flash=69">
                                <xsl:value-of
                                        select="string('Flash fired, red-eye reduction mode, return light not detected')"/>
                            </xsl:when>
                            <xsl:when test="$flash=71">
                                <xsl:value-of
                                        select="string('Flash fired, red-eye reduction mode, return light detected')"/>
                            </xsl:when>
                            <xsl:when test="$flash=73">
                                <xsl:value-of
                                        select="string('Flash fired, compulsory flash mode, red-eye reduction mode')"/>
                            </xsl:when>
                            <xsl:when test="$flash=77">
                                <xsl:value-of
                                        select="string('Flash fired, compulsory flash mode, red-eye reduction mode, return light not detected')"/>
                            </xsl:when>
                            <xsl:when test="$flash=79">
                                <xsl:value-of
                                        select="string('Flash fired, compulsory flash mode, red-eye reduction mode, return light detected')"/>
                            </xsl:when>
                            <!--
                            ...
                            <xsl:when test="$flash=93">
                                <xsl:value-of
                                        select="string('Flash fired, auto mode, return light not detected, red-eye reduction mode')"/>
                            </xsl:when>
                            <xsl:when test="$flash=95">
                                <xsl:value-of
                                        select="string('Flash fired, auto mode, return light detected, red-eye reduction mode')"/>
                            </xsl:when>
                        </xsl:choose>
                    </flash>
